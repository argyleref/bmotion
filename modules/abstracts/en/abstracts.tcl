...
bMotion_abstract_register "answerWhos" {
	...
	"me"
	"you"
	"that one guy who always disagrees with me at my book club"
	"Jason Stephens"
	"Jason Stephens as Morgan Freeman"
	"King Kandy"
	"monica"
	"Joe 'vagina impaler' Biden"
	"some jerk"
	"Jason Stephens as John Madden"
	"those assholes who live nextdoor to me"
	"the entire cast of 'Cool as Ice'"
	"Mao Zedong"
	"Hwoarang"
	"Courtney Collins"
	"Feuhorbe"
...
bMotion_abstract_register "answerWithWhos" {
	...
	"somewhere around three dozen but probably more"
}
...
bMotion_abstract_register "answerWhys_male" {
	"Because it's on the tip of my dick."
}
...
bMotion_abstract_register "answerWheres" {
	...
	"in %VAR{cities}"
	"behind the bushes"
	"under a truck traveling at 65 MPH"
}
bMotion_abstract_register "answerWellbeing" {
	...
	"Everything sucks but I suppose it could be worse."
	"Not very good. I've been thinking a lot today... Am I a robot?"
}
...
bMotion_abstract_register "answerHows" {
	...
	"Drugs and teamwork"
	"Just say the magic words - 'please and gimme'"
}
...
"the floor"
"the dice"
"Chunk the coal miner"
"Zandar"
"The Gatekeeper"
"Egotiztical Snifff"
"an ice cream knife"
"the crispy sheet"
"a collection of twist ties"
"chickens"
}

bMotion_abstract_register "charges" {
	"exploding %VAR{bbgNouns}"
	"setting fire to %VAR{bbgNouns}"
	"gross incompetence"
	"talking over somebody"
	"existing"
	"misuse of %VAR{bbgNouns}"
	"improper use of %VAR{bbgNouns}"
	"improper conduct with %VAR{bbgNouns}"
	"plotting with %VAR{bbgNouns}"
	"spilling a shot"
	"spilling a beer"
	"fighting with %VAR{bbgNouns}"
	"attempting to steal %VAR{bbgNouns}"
	"attacking %VAR{bbgNouns}"
	"putting %VAR{bbgNouns} into a headlock"
	"eating %VAR{bbgNouns}"
	"leaving before the show is over"
	"being late"
	"burping way too loud"
	"stabbing at least twelve and a half people"
	"being on the prostitution track"
	"rolling doubles three times in a row"
}

bMotion_abstract_register "punishments" {
	"eat rip's whips"
	"be stoned to death in a headband hoop game"
	"be banished to the black hole"
	"drink a bottle of black krak"
	"eat a big bag of dirt"
	"be smacked with a chilled wrench by Larry Cardbourde"
	"drink beer that tastes like bananas"
	"drink beer that is too hoppy"
	"lick %% clean"
	"play the Kreskin ESP game twice"
	"listen to Dylan say nahnahnononono for five hours straight"
	"explain what 2-3-4 means"
	"be King Kandy's slave for all eternity"
	"go on a cape date"
}

bMotion_abstract_register "brigbrigBanzais" {
...
bMotion_abstract_register "randomReplies" {
	...
	"Uhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh. I can't remember. Shit."
}
...
bMotion_abstract_register "bbgNouns" {
"Aaron Yonda"
"Matt Sloan"
"Andrew Yonda"
"Jason Stephens"
...
bMotion_abstract_register "bbgCharges" {
	"exploding %VAR{bbgNouns}"
	"setting fire to %VAR{bbgNouns}"
	"gross incompetence"
	"talking over somebody"
...
bMotion_abstract_register "bbgPunishments" {
	"eat rip's whips"
	"be stoned to death in a headband hoop game"
	"be banished to the black hole"
	"drink a bottle of black krak"
